...
| ID      | Description                                                                                                                                                                                                                                                                                                                                             | Status  |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| SHR-001 | `database.spec.ts` — `getDatabaseKind()`: identifies `postgres://`/`postgresql://` as `'postgres'`; identifies `file:`/`sqlite:`/`libsql:` as `'sqlite'`; throws a clear, actionable error naming both supported families on an unrecognized scheme (e.g. `mysql://`); propagates the underlying error on a malformed URL rather than misclassifying it | Passing |
